...
function parseStructTag(type) {
  ...
  const typeParams = rest.includes("<") ? (0, import_bcs2.splitGenericParameters)(rest.slice(rest.indexOf("<") + 1, rest.lastIndexOf(">"))).map(
...
var PublicKey = class {
  ...
  toSuiAddress() {
    return normalizeSuiAddress(
      (0, import_utils.bytesToHex)((0, import_blake2b.blake2b)(this.toSuiBytes(), { dkLen: 32 })).slice(0, SUI_ADDRESS_LENGTH * 2)
    );
  }
};
...
function toMultiSigAddress(pks, threshold) {
  ...
  return normalizeSuiAddress((0, import_utils3.bytesToHex)((0, import_blake2b2.blake2b)(tmp.slice(0, i), { dkLen: 32 })));
}
...
var SuiTransactionBlockKind = (0, import_superstruct5.union)([
  ...
  (0, import_superstruct5.assign)(ProgrammableTransaction, (0, import_superstruct5.object)({ kind: (0, import_superstruct5.literal)("ProgrammableTransaction") }))
]);
...
var ExecutionStatusType = (0, import_superstruct5.union)([(0, import_superstruct5.literal)("success"), (0, import_superstruct5.literal)("failure")]);
...
var MutableReferenceOutputType = (0, import_superstruct5.tuple)([SuiArgument, (0, import_superstruct5.array)((0, import_superstruct5.number)()), (0, import_superstruct5.string)()]);
...
var SuiMoveFunctionArgType = (0, import_superstruct6.union)([(0, import_superstruct6.string)(), (0, import_superstruct6.object)({ Object: (0, import_superstruct6.string)() })]);
...
var SuiMoveVisibility = (0, import_superstruct6.union)([(0, import_superstruct6.literal)("Private"), (0, import_superstruct6.literal)("Public"), (0, import_superstruct6.literal)("Friend")]);
...
var SuiMoveNormalizedModules = (0, import_superstruct6.record)((0, import_superstruct6.string)(), SuiMoveNormalizedModule);
...
var Secp256r1Keypair = class _Secp256r1Keypair extends Keypair {
  ...
  static deriveKeypair(mnemonics, path) {
    ...
    const privateKey = import_bip322.HDKey.fromMasterSeed(mnemonicToSeed(mnemonics)).derive(path).privateKey;
...
var TARGETED_RPC_VERSION = "1.9.0";
...
// src/builder/Transactions.ts
var option = (some) => (0, import_superstruct15.union)([(0, import_superstruct15.object)({ None: (0, import_superstruct15.union)([(0, import_superstruct15.literal)(true), (0, import_superstruct15.literal)(null)]) }), (0, import_superstruct15.object)({ Some: some })]);
...
var MoveCallTransaction = (0, import_superstruct15.object)({
  ...
  target: (0, import_superstruct15.define)("target", (0, import_superstruct15.string)().validator),
...
var TransactionExpiration = (0, import_superstruct18.optional)(
  (0, import_superstruct18.nullable)(
    (0, import_superstruct18.union)([(0, import_superstruct18.object)({ Epoch: (0, import_superstruct18.integer)() }), (0, import_superstruct18.object)({ None: (0, import_superstruct18.union)([(0, import_superstruct18.literal)(true), (0, import_superstruct18.literal)(null)]) })])
  )
);
...
var _TransactionBlock = class _TransactionBlock {
  ...
  setGasPayment(payments) {
    __privateGet(this, _blockData).gasConfig.payment = payments.map((payment) => (0, import_superstruct19.mask)(payment, SuiObjectRef));
  }
...
var JsonRpcProvider = class {
  ...
  async getTotalTransactionBlocks() {
    const resp = await this.client.requestWithType("sui_getTotalTransactionBlocks", [], (0, import_superstruct20.string)());
    return BigInt(resp);
  }
  /**
  ...
  async getReferenceGasPrice() {
    const resp = await this.client.requestWithType("suix_getReferenceGasPrice", [], (0, import_superstruct20.string)());
    return BigInt(resp);
  }
  /**
...
async function verifyMessage(message, serializedSignature, scope) {
  ...
  if (scope === 3 /* PersonalMessage */) {
    const messageBytes2 = messageWithIntent(
      scope,
      bcs.ser(["vector", "u8"], typeof message === "string" ? (0, import_bcs31.fromB64)(message) : message).toBytes()
    );
    if (await signature.pubKey.verify((0, import_blake2b8.blake2b)(messageBytes2, { dkLen: 32 }), signature.signature)) {
      return true;
    }
  ...
  return signature.pubKey.verify((0, import_blake2b8.blake2b)(messageBytes, { dkLen: 32 }), signature.signature);
}
