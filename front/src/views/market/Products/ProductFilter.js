            ...
            {isCategoriesLoading ? (
                ...
                <>
                    <Grid item xs={6}>
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox checked={categories.some((item) => item === 'suifrens')} />}
                            onChange={() => handelFilter('categories', 'suifrens')}
                            label="Suifrens"
                        />
                        <FormControlLabel
                            control={<Checkbox checked={categories.some((item) => item === 'fuddies')} />}
                            onChange={() => handelFilter('categories', 'fuddies')}
                            label="Fuddies"
                        />
                    </Grid>
                    <Grid item xs={6}>
                        <FormControlLabel
                            control={<Checkbox checked={categories.some((item) => item === 'suishi')} />}
                            onChange={() => handelFilter('categories', 'suishi')}
                            label="Suishi"
                        />
                        <FormControlLabel
                            control={<Checkbox checked={categories.some((item) => item === 'gommies')} />}
                            onChange={() => handelFilter('categories', 'gommies')}
                            label="Gommies"
                        />
                        <FormControlLabel
                            control={<Checkbox checked={categories.some((item) => item === 'cosmocadia')} />}
                            onChange={() => handelFilter('categories', 'cosmocadia')}
                            label="Cosmocadia"
                        />
                    </Grid>
                </>
